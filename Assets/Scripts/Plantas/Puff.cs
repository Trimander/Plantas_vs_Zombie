...
public class Puff : MonoBehaviour {
    ...
    void Spawn(){
        RaycastHit2D hit = Physics2D.Raycast(canhao.position, Vector3.right, 3.5f, layerZombie); // Joga um raio a partir da posição do canhao no sentido da direita para verificar se existe zombie
